...
;(function path(win, doc, pv) {
     ...
     * @public
     * @function
     * @alias getCuboidPathsAt
     * @memberof PerspectiveView.path
     *
     * @param  {Object} mapPosition - XY-Position in the map array
     * @return {Array}
     */
    pub.getCuboidPathsAt = function getCuboidPathsAt(mapPosition, depth) {
    ...
    pub.getFlatShapePathAt = function getFlatShapePathAt(mapPosition) {
